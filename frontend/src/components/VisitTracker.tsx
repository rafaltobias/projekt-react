...
interface VisitTrackerProps {
  onVisitTracked?: (result: any) => void;
}

const VisitTracker: React.FC<VisitTrackerProps> = ({ onVisitTracked }) => {
  ...
  const [isEntryPage, setIsEntryPage] = useState<boolean>(false);
  const [isExitPage, setIsExitPage] = useState<boolean>(false);
