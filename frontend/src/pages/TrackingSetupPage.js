            ...
            <div className="mb-10">
              ...
              <div className="relative bg-gray-900 rounded-xl overflow-hidden shadow-lg">
                ...
                <button
                  ...
                  className="btn absolute top-16 right-4 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm transition-colors duration-200 flex items-center space-x-2"
                >
